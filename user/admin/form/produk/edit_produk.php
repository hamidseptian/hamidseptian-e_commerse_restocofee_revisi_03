<div class="box-header with-border">
  ...
  <div class="box-tools pull-right">
    <a href="?m=produk" class="btn btn-info" >Kembali</a>
  </div>
</div>
...
<form action="form/produk/simpanedit_produk.php" method="post" enctype="multipart/form-data">
  <div class="col-md-5">
     <img src="form/produk/gambar/<?php echo $gambar ?>" style="width:100%">
  ...
  <div class="col-md-7">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="fotolama" class="form-control" value="<?php echo $d1['gambar_produk'] ?>">
              </div> 
               <div class="form-group">
                  <label>Jenis produk</label>
                  <select name="jenis" class="form-control">
                    <option value="Makanan">Makanan</option>
                    <option value="Minuman" <?php if($d1['jenis']=='Minuman'){echo "selected";} ?>>Minuman</option>
                  </select>
              </div> 
              <div class="form-group">
                  <label>Harga</label>
