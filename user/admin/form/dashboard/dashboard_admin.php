<?php 
  ...
  $prt=mysqli_query($conn, "SELECT * from admin where id_admin='$idus'")or die("salah");
...
<div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-aqua-active">
              <h5 class="widget-user-desc">Selamat datang di halaman administrator aplikasi Marketplace Restoran dan Coffee Shop </h5>
