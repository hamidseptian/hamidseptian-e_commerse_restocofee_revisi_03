...
?>
  ...
  <a href="../../home/form/order/print_faktur.php?id_toko=<?php echo $idtoko ?>&waktu=<?php echo $waktu ?>&id_pelanggan=<?php echo $id ?>" class="btn btn-info btn-sm" target="_blank">Print Faktur</a>
