...
<?php 
  $q1=mysqli_query($conn, "SELECT * from pesanan 
    ...
    where produk.id_toko='$id' and pesanan.status_pesanan in ('Order','Proses','Di antarkan','Di jemput pelanggan') group by pesanan.id_pelanggan, pesanan.tanggal_pesan");
  $no=1;
 ?>
